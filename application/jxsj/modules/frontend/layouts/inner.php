...
<div class="wrapper" id="inner-page">
	...
	<div id="content">
		...
		<div id="main-content">
			...
			<?php if(!empty($banner)){?>
				<div id="sub-banner"><img src="<?php echo $this->view->staticFile('images/'.$banner)?>" height="145" /></div>
			<?php }?>
			<?php echo $content;?>
		</div>
		<div class="clear"></div>
...
<script type="text/javascript" src="<?php echo $this->view->url()?>js/jquery.masonry.min.js"></script>
<script type="text/javascript" src="<?php echo $this->view->url()?>js/custom/fayfox.fixcontent.js"></script>
<script>
